      ...
      <div className="flex flex-wrap items-center">
        ...
        <div className="w-[13.5%] mt-[10px] mr-[6px] h-[38px]  bg-white">
          <Select
            ...
            value={badge}
          >
            <SelectTrigger className={`${badge}` === ' ' ? 'text-[#aaa]' : ''}>
        ...
        <div className="w-[13.5%] mt-[10px] mr-[6px] h-[38px]  bg-white">
          <Select
            ...
            value={engine}
          >
            <SelectTrigger className={`${engine}` === ' ' ? 'text-[#aaa]' : ''}>
        ...
        <div className="w-[13.5%] mt-[10px] mr-[6px] h-[38px]  bg-white">
          <Select
            ...
            value={drive}
          >
            <SelectTrigger className={`${drive}` === ' ' ? 'text-[#aaa]' : ''}>
        ...
        <div className="w-[13.5%] mt-[10px] mr-[6px] h-[38px]  bg-white">
          <Select
            ...
            value={doors}
          >
            <SelectTrigger className={`${doors}` === ' ' ? 'text-[#aaa]' : ''}>
        ...
        <div className="w-[13.5%] mt-[10px] mr-[6px] h-[38px]  bg-white">
          <Select
            ...
            value={states}
          >
            <SelectTrigger className={`${states}` === ' ' ? 'text-[#aaa]' : ''}>
